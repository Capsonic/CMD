...
namespace Data_Base_MNG
{
    ...
    public class SQL
    {
        ...
        public DataTable Execute_Query_Open_Connection(string Query)
        {
            DataTable tabla = new DataTable();
            Build_Command(Query);
            try
        ...
        public void Load_SP_Parameters(string ParameterName, object ParameterValue)
        {
        ...
        public bool Execute_Query_With_Parameters(string Command, List<SqlParameter> parameters)
        {
            Build_Command(Command);
